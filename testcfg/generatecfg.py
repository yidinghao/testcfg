...
if __name__ == '__main__':
    ...
    parser.add_argument("--terminalprob", help="Probability that a symbol on the rhs will be a terminal", type=float,
                        default=0.5)
    ...
    parser.add_argument("--preterminals", default=0,
                        help="If this (the number of preterminal productions) is greater than 0, then we introduce all terminals with a preterminal.",
                        type=int)
    ...
    parser.add_argument("--unaryrules", action="store_true", default=False,
                        help="If set then unary rules will have terminals on the right hand side. ")
    parser.add_argument("--no_lexical_ambiguity", action="store_true", default=False,
                        help="If set then all terminals are different.")
    parser.add_argument("--minntrhs", type=int, default=0,
                        help="Minimum number of productions that each nonterminal appears on rhs of.")
    parser.add_argument("--minntlhs", type=int, default=0,
                        help="Minimum number of productions that each nonterminal appears on lhs of.")
